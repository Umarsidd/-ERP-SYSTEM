...
export default function PurchasesInvoicePurchasesManagement() {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      <HomeHeader
        ...
        isMobile={isMobile}
        title={isRTL ? "إدارة فواتير الشراء" : "Purchase Invoice Management"}
        description={
          isRTL
        ...
        href={"/purchase/invoices/create-invoice"}
      ...
      <StatsCards
        data={[
          {
            title: isRTL ? "إجمالي فواتير الشراء" : "Total Purchase Invoices",
            value: totalElements,
