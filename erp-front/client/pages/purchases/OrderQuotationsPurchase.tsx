...
const OrderQuotationsPurchase: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <HomeHeader
        ...
        setViewMode={null}
        isMobile={null}
        title={isRTL ? " طلبات عرض الاسعار " : "Purchase Quotations"}
        description={
          isRTL
            ? "إدارة وتتبع طلبات عرض الأسعار والاقتراحات التجارية"
            : "Manage and track price quotations and business proposals"
        }
        other={isRTL ? "عرض سعر جديد" : "New Quotation"}
        href={"/purchase/order-quotations/create"}
        sectionName={"Purchases"}
        pageName={"PurchaseQuotations"}
      />
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold">
            {isRTL ? " طلبات عرض سعر " : "Quotations Orders"} (
            {quotations.length})
          </h2>
        </div>

        {isLoading ? (
          <Loading title={isRTL ? "جاري تحميل العروض..." : "Loading..."} />
        ) : (
          <SecondaryList
            type="purchase"
            ...
            title={isRTL ? "طلب عرض سعر" : "QUOTATION ORDER"}
            sectionName={"Purchases"}
        ...
        {quotations.length === 0 && !isLoading && (
          <EmptyState
            ...
            title={
              isRTL
                ? "لم يتم العثور على طلبات عرض سعر"
                : "No quotations order found"
            }
            description={
              isRTL
                ? "ابدأ بإنشاء طلب عرض سعر جديد"
                : "Get started by creating a new quotation order"
            }
...
export default OrderQuotationsPurchase;
