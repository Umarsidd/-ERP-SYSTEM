...
const ViewPurchaseQuotation: React.FC = () => {
  ...
  if (!quotation) {
    return (
      <ViewEmpty
        title={isRTL ? "العرض غير موجود" : "Quotation Not Found"}
        description={
          isRTL
            ? "العرض المطلوب غير متوفر"
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 mb-6 sm:mb-8">
        <div className="flex items-center space-x-4 rtl:space-x-reverse">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground">
              {isRTL ? "تفاصيل العرض" : "Quotation Details"}
            </h1>
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <>
              {quotation.status == "Approved" && (
                ...
                >
                  ...
                  <span className="hidden sm:inline">
                    {isRTL ? "تحويل الى امر شراء" : "Convert to Purchase Order"}
                  </span>
                </Button>
              )}
              <Button
          ...
          <Button
            ...
            onClick={() => {
              handleCopy(
                isRTL ? "نسخ العرض" : "Copy Quotation",
                isRTL
                  ? `هل تريد نسخ العرض ${quotation.elementNumber}؟`
                  : `Do you want to copy quotation ${quotation.elementNumber}?`,
                quotation,
                isRTL,
                navigate,
                "/purchase/quotations/create",
              );
            }}
          >
          ...
          {((JSON.parse(localStorage.getItem("subRole") || "null") as any)
            ?.Purchases?.deletingAndEditingAllPriceQuotes !== false ||
            ((JSON.parse(localStorage.getItem("subRole") || "null") as any)
              ?.Purchases?.deletingAndEditingHisPriceQuotes === true &&
              JSON.parse(
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                handleEdit(quotation, navigate, `/purchase/quotations/edit`)
              }
