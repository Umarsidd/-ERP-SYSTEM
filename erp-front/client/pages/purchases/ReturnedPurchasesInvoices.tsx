...
const PurchasesReturnedInvoices: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <HomeHeader
        ...
        setViewMode={null}
        isMobile={null}
        title={isRTL ? "فواتير الشراء المرتجعة" : "Returned Purchase Invoices"}
        description={
          isRTL
            ? "إدارة ومتابعة فواتير الشراء المرتجعة وطلبات الاسترداد"
            : "Manage and track returned purchase invoices and refund requests"
        }
        other={
          null
          //isRTL ? "إرجاع جديد" : "New Return"
        }
        href="/purchase/return/create"
        sectionName={"Purchases"}
        pageName={"PurchaseReturns"}
      />
      ...
      {/* <StatsCards
        data={[
          {
            title: isRTL ? "إجمالي مرتجعات الشراء" : "Total Purchase Returns",
            value: totalElements,
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold">
            {isRTL ? "فواتير الشراء المرتجعة" : "Returned Purchase Invoices"} (
            {mainData.length})
          </h2>
        </div>
...
export default PurchasesReturnedInvoices;
