...
const PurchasesViewReturn: React.FC = () => {
          ...
          <Button
            ...
            onClick={() => {
              printUnifiedInvoice(
                ...
                isRTL,
                "purchase_returns", // tableName
                formatAmount,
                convertAmount,
                isRTL ? "مرتجع مشتريات" : "PURCHASE RETURN" // title
              );
            }}
          >
          ...
          {((JSON.parse(localStorage.getItem("subRole") || "null") as any)
            ...
            ((JSON.parse(localStorage.getItem("subRole") || "null") as any)
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  handleEdit(mainData, navigate, `/purchase/return/edit`)
                }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="font-semibold">
                  {mainData?.dueDate && format(mainData?.dueDate, "PPP")}
                </p>
              </div>
...
export default PurchasesViewReturn;
