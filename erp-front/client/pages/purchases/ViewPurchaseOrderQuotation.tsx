...
const ViewPurchaseOrderQuotation: React.FC = () => {
    const { id } = useParams();
  ...
  if (!quotation) {
    return (
      <ViewEmpty
        title={isRTL ? "طلب العرض غير موجود" : "Quotation Order Not Found"}
        description={
          isRTL
            ? "طلب العرض المطلوب غير متوفر"
            : "The requested quotation order could not be found"
        }
      />
    );
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 mb-6 sm:mb-8">
        <div className="flex items-center space-x-4 rtl:space-x-reverse">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground">
              {isRTL ? "تفاصيل طلب العرض" : "Quotation Order Details"}
            </h1>
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              {quotation.status == "Approved" && (
                <Button
                  ...
                  onClick={async () => {
                    ...
                    navigate("/purchase/quotations/create", {
                ...
                >
                  ...
                  <span className="hidden sm:inline">
                    {isRTL ? "تحويل الى عرض مشتريات" : "Convert to Quotation"}
                  </span>
                </Button>
              )}
              <Button
          ...
          <Button
            ...
            onClick={() => {
              handleCopy(
                isRTL ? "نسخ طلب العرض" : "Copy Quotation Order",
                isRTL
                  ? `هل تريد نسخ طلب العرض ${quotation.elementNumber}؟`
                  : `Do you want to copy quotation order ${quotation.elementNumber}?`,
                quotation,
                isRTL,
                navigate,
                "/purchase/order-quotations/create",
              );
            }}
          >
          ...
          {/* <Button
            ...
            onClick={() => {
              printQuotation(
                {
                  ...JSON.parse(quotation.main),
                  title: isRTL ? "طلب عرض الاسعار" : "QUOTATION ORDER",
                  // element: isRTL
                  //   ? "بنود العرض"
                  //   : "Quotation Items",
                },
            ...
            <Button
              ...
              onClick={() =>
                handleEdit(
                  quotation,
                  navigate,
                  `/purchase/order-quotations/edit`,
                )
              }
...
export default ViewPurchaseOrderQuotation;
