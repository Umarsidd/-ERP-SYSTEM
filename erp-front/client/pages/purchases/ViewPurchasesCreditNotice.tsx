...
import { Calendar, User, DollarSign, Printer, Edit, Copy } from "lucide-react";
...
const PurchasesViewCreditNotice: React.FC = () => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 mb-6 sm:mb-8">
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <Button
            ...
            onClick={() => {
              handleCopy(
                ...
                isRTL,
                navigate,
                "/purchase/credit-notices/create",
              );
            }}
          >
          ...
          <Button
            ...
            onClick={() => {
              printUnifiedInvoice(
                ...
                isRTL,
                "purchase_credit_notices", // tableName
                formatAmount,
                convertAmount,
                isRTL ? "اشعار مدين" : "DEBIT NOTICE" // title for Purchase Side Credit Note (Debit Note)
              );
            }}
          >
          ...
          {((JSON.parse(localStorage.getItem("subRole") || "null") as any)
            ?.Purchases?.deletingAndEditingAllCreditNotices !== false ||
            ((JSON.parse(localStorage.getItem("subRole") || "null") as any)
              ?.Purchases?.deletingAndEditingHisCreditNotices === true &&
              JSON.parse(
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  handleEdit(mainData, navigate, `/purchase/credit-notices/edit`)
                }
...
export default PurchasesViewCreditNotice;
