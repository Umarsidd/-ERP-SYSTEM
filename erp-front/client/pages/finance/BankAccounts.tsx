...
import { handleCopy, handleView, mainFilter } from "@/lib/function";
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <HomeHeader
        ...
        setViewMode={null}
        isMobile={null}
        title={isRTL ? "خزائن وحسابات بنكية" : "Bank Accounts"}
        description={
          isRTL
            ? "إدارة وتتبع الحسابات البنكية"
            : "Manage and track bank accounts"
        }
        other={isRTL ? " انشاء جديد" : "Create New"}
        href={"/finance/bank-accounts/create"}
        sectionName={"Finance"}
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold">
            {isRTL ? "خزائن وحسابات بنكية" : "Bank Accounts"} ({orders.length})
          </h2>
        </div>
        ...
        {orders.length === 0 && !isLoading && (
          <EmptyState
            ...
            title={
              isRTL
                ? "لم يتم العثور على الحسابات البنكية"
                : "No bank accounts found"
            }
            description={
              isRTL
                ? "ابدأ بإنشاء حساب بنكي جديد"
