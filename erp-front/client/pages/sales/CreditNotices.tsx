  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <HomeHeader
        ...
        setViewMode={null}
        isMobile={null}
        title={isRTL ? "الإشعارات الدائنة" : "Credit Notices"}
        description={
          isRTL
        ...
        href={"/sales/credit-notices/create"}
        sectionName={"Sales"}
      ...
      {/* <StatsCards
        data={[
          ...
          },
          {
            ...
            value: mainData.filter((cn) => cn.stockStatus === "stockPending")
              .length,
            icon: <Clock className="w-8 h-8 text-success" />,
          },
          {
            title: isRTL ? "موافقة" : "Approved",
            value: mainData.filter((cn) => cn.stockStatus === "stockApproved")
              .length,
          ...
          },
          {
            ...
            value: formatAmount(
              convertAmount(
                mainData.reduce((sum, cn) => sum + cn.totalAmount, 0),
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold">
            {isRTL ? "الإشعارات الدائنة" : "Credit Notices"} ({totalElements})
          </h2>
        </div>
        {isLoading ? (
