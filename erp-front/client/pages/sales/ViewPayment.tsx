...
const ViewPayment: React.FC = () => {
  ...
  const handlePrintReceipt = () => {
    ...
    useEffect(() => {
      console.log(JSON.parse(payment.main));
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <div className="flex items-center gap-3">
            ...
            {((JSON.parse(localStorage.getItem("subRole") || "null") as any)
              ?.Sales?.deletingAndEditingAllPayments !== false ||
              ((JSON.parse(localStorage.getItem("subRole") || "null") as any)
                ?.Sales?.deletingAndEditingHisPayments === true &&
                JSON.parse(
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  handleEdit(payment, navigate, `/sales/payments/edit`)
                }
