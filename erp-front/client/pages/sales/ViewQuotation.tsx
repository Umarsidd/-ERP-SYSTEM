      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0 mb-6 sm:mb-8">
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              {quotation.status == "Approved" && (
                <Button
                  ...
                  onClick={async () => {
                    ...
                    navigate("/sales/invoices/create-invoice", {
          ...
          {((JSON.parse(localStorage.getItem("subRole") || "null") as any)
            ?.Sales?.deletingAndEditingAllPriceQuotes !== false ||
            ((JSON.parse(localStorage.getItem("subRole") || "null") as any)
              ?.Sales?.deletingAndEditingHisPriceQuotes === true &&
              JSON.parse(
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                handleEdit(quotation, navigate, `/sales/quotations/edit`)
              }
