...
export function AddCustomer(props: {
  ...
  const [initialValues, setInitialValues] = useState({
    name: "",
    type: "individual",
    elementNumber: generateNumber("CUS"),
    code: generateNumber("CUS"),
    ...
    try {
      ...
      if (res.result === false) {
        ...
        if (location.state?.action == "edit") {
          ...
          await authApi.update(location.state?.newData.id, {
                ...
                <div className="flex items-center space-x-4 rtl:space-x-reverse mt-12 sm:mt-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                      {isRTL
                        ? "أدخل تفاصيل العميل بالكامل، يمكنك إضافة جهات اتصال متعددة ومعلومات ضريبية وملاحظات"
                        : "Enter full customer details, add multiple contacts, tax info and notes."}
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            <Card className="p-4 md:p-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <Label>{isRTL ? "معرف العميل" : "Customer ID"}</Label>
                  <Input
                    disabled
                    name="code"
                    value={values.code}
              ...
              {/* File Attachments */}
              <div
                className="bg-card border border-border rounded-xl p-6 animate-slide-in-up mt-4"
