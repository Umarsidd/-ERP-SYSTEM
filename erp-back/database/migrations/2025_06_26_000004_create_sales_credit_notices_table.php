...
return new class extends Migration
{
    ...
    {
        Schema::create('sales_credit_notices', function (Blueprint $table) {
            $table->id();
            $table->softDeletes();
            // $table->timestamps();
            $table->string('tableName')->default('sales_credit_notices');
    ...
    {
        Schema::dropIfExists('sales_credit_notices');
    }
};
