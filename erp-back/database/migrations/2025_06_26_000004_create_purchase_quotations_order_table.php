...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_quotations_order', function (Blueprint $table) {
            $table->id();
            $table->softDeletes();
            // $table->timestamps();
            $table->string('tableName')->default('purchase_quotations_order');
    ...
    {
        Schema::dropIfExists('purchase_quotations_order');
    }
};
